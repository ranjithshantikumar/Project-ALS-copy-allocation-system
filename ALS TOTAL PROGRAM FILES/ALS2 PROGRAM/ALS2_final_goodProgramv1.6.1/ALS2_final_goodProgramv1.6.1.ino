...
last good program 1.6.1stackSize_select_ok
*/
...
{
  bool CopycountFlg = bitRead(Asa, 23);
  if (CopycountFlg == 1)
  {
    Batch_counter_MTS1++;
  }
  ...
  bool CopycountFlg2 = bitRead(Asa2, 29);
  if (CopycountFlg2 == 1)
  {
    Batch_counter_MTS2++;
  }
...
void loop() {
  ...
  bool opengripper = bitRead(Asa, 23);
  ...
  // for mts 2
  bool opengripper2 = bitRead(Asa2, 29);
